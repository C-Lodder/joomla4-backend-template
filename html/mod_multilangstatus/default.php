...
<div class="multilanguage d-flex align-items-center">
	<button class="btn nav-link d-flex align-items-center" href="#multiLangModal" title="<?php echo Text::_('MOD_MULTILANGSTATUS'); ?>" data-bs-toggle="modal">
		...
		<span class="visually-hidden"><?php echo Text::_('MOD_MULTILANGSTATUS'); ?></span>
	</button>
